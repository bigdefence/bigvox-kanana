...
def preprocess(
    ...
    if conversation_lib.default_conversation.sep_style == conversation_lib.SeparatorStyle.KANANA:
        return preprocess_kanana(sources, tokenizer, has_speech=has_speech)
